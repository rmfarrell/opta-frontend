...
app.controller("stats", function($scope, $http, $route, $filter) {
	
	
});

app.controller("passmap", function ($scope, $http, $route, $filter, gameService){
	...
	$scope.getGame = gameService.getGameInfo($scope.gameId).success(function() {
